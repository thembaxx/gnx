        ...
        >
            ...
            render={({ field }) => (
              <FormItem>
                <FormControl>
                  <motion.div
                    layout="size"
                    className={cn("h-13", { "resize-y h-32": isOpen })}
                  >
                    <Textarea
                      placeholder="Type your message here"
                      className={cn(
                        "resize-none text-base bg-transparent h-full min-h-0 rounded-2xl ring-doger-blue/40 pb-0 pr-10",
                        {
          ...
          >
              ...
              {isOpen && (
                ...
                >
                  <Button size="icon" type="button" variant="ghost">
                    <GalleryIcon className="!h-5 !w-5 p-0 text-muted-foreground" />
                  </Button>
                  <Button size="icon" type="button" variant="ghost">
                    <SoundwaveIcon className="!h-5 !w-5 p-0 text-orange-500" />
                  </Button>
                  <Button size="icon" type="button" variant="ghost">
                    <StickerIcon className="!h-5 !w-5 p-0 text-violet-700" />
                  </Button>
                </motion.div>
              )}
            </AnimatePresence>
            <motion.div className="flex items-center h-full space-x-2">
              ...
              >
                {isOpen && (
                  <ExpandIcon className="!h-5 !w-5 p-0 text-muted-foreground" />
                )}
                {!isOpen && (
                  <CompactIcon className="!h-5 !w-5 p-0 text-violet-700" />
                )}
              </Button>
              <Button
