          ...
          {error && (
            <div className="space-y-8 flex flex-col items-center pt-4">
              <div className="flex items-center justify-center bg-[#D70015]/10 h-16 w-16 rounded-full">
                <MicOffIcon className="h-7 w-7 text-[#D70015]" />
              </div>
              <div className="space-y-4 max-w-60 w-full flex flex-col items-center overflow-hidden">
                <p className="text-center text-xs uppercase">{error}</p>
                <p className="text-center text-sm leading-5 text-secondary-foreground/60 text-pretty">
